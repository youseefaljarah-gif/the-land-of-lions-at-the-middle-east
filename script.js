...
events.forEach(ev => {
  const color = ev.type === "سياسي" ? "blue" : ev.type === "عسكري" ? "red" : ev.type === "اقتصادي" ? "yellow" : "green";
...
// ------------------------
// 2️⃣ الأخبار المباشرة النموذجية
...
// ------------------------
// 5️⃣ دمج الأخبار الحقيقية لاحقًا عبر JSON Endpoint
